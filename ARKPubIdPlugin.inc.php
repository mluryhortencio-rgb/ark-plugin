...
use Plugins\PubIds\Ark\Classes\Form\FieldArk;
...
class ARKPubIdPlugin extends PKPPubIdPlugin {
    ...
    // REMOVIDOS: hooks de Galley e Issue, não suportados no 3.5
    // \HookRegistry::register('Galley::getProperties::summaryProperties', ...);
    // \HookRegistry::register('Galley::getProperties::fullProperties', ...);
    // \HookRegistry::register('Galley::getProperties::values', ...);
    // \HookRegistry::register('Issue::getProperties::summaryProperties', ...);
    // \HookRegistry::register('Issue::getProperties::fullProperties', ...);
    // \HookRegistry::register('Issue::getProperties::values', ...);
    ...
    public function getPubId($pubObject) {
        return $pubObject->getStoredPubId('ark');
    }
    ...
    $this->addJavaScript(
        ...
        TemplateManager::getManager(Application::get()->getRequest())
    );

    $form->addField(new FieldArk('pub-id::ark', [
        'label' => __('plugins.pubIds.ark.displayName'),
